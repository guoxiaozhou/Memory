 ...
 */
public class AddEventSetActivity extends com.jeek.calendar.activity.BaseActivity implements View.OnClickListener, OnTaskFinishedListener<EventSet>, SelectColorDialog.OnSelectColorListener {
    ...
    public void onClick(View v) {
        if(v.getId()==R.id.tvCancel){
            ...
            addEventSet();
        }else if(v.getId()==R.id.rlEventSetColor){
