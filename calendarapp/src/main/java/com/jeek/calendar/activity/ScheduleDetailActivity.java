 ...
 */
public class ScheduleDetailActivity extends com.jeek.calendar.activity.BaseActivity implements View.OnClickListener, OnTaskFinishedListener<Map<Integer, EventSet>>, SelectDateDialog.OnSelectDateListener, InputLocationDialog.OnLocationBackListener, SelectEventSetDialog.OnSelectEventSetListener {
    ...
    public void onClick(View v) {
        ...
        }else if(v.getId()==R.id.llScheduleTime){
            showSelectDateDialog();
        }else if(v.getId()==R.id.llScheduleLocation){
