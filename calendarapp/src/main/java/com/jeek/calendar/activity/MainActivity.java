...
public class MainActivity extends com.jeek.calendar.activity.BaseActivity implements View.OnClickListener, OnTaskFinishedListener<List<EventSet>> {
    ...
    public void resetMainTitleDate(int year, int month, int day) {
        ...
        Log.i("MainActivity","resetMainTitleDate"+"year:"+year+" month:"+month+" day:"+day);
    ...
    public void onClick(View v) {
        ...
        }else if(v.getId()==R.id.llMenuSchedule){
            gotoScheduleFragment();
        }else if(v.getId()==R.id.llMenuNoCategory){
        ...
        }else if(v.getId()==R.id.tvMenuAddEventSet){
